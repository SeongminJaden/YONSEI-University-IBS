    ...
    methods (Access = private)
        ...
        function createLogPanel(obj)
            ...
            obj.LogPanel = uipanel(obj.Figure, ...
                'Title', 'Log', ...
                'Position', [20, 20, 860, 140]);

            obj.LogTextArea = uitextarea(obj.LogPanel, ...
                'Position', [10, 10, 840, 105], ...
                'Editable', 'off', ...
